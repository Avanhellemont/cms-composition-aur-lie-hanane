...
<form action="" method="post" class="form_wp_osm">
	...
	<input type="submit" value="<?php _e('Save map', 'wp-open-street-map') ?>" class="button button-primary" /> <a href="<?= admin_url('admin.php?page=wp_openstreetmaps'); ?>"><?php _e('Back to maps list', 'wp-open-street-map') ?></a>
